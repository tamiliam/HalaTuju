    ...
    <main className="min-h-screen bg-ground-50">
      ...
      <div className="container mx-auto px-6 py-8 max-w-2xl">
        <div className="bg-ground-0 rounded-xl border border-ground-200 p-6 space-y-4">
          <h1 className="text-2xl font-bold text-ground-900 mb-2">{t('common.privacy')}</h1>
          <p className="text-sm text-ground-500">Last updated: July 2026</p>

          <p className="text-ground-600">
            HalaTuju provides two things: a free <strong>course-matching tool</strong> for
            SPM/STPM students, and the <strong>{b.programmeName.en} Programme</strong>, which
            connects verified low-income students with sponsors who support their public
            tertiary studies. This policy covers both.
          </p>

          <h2 className="text-lg font-semibold text-ground-900">Data we collect</h2>
          <ul className="list-disc pl-6 text-ground-600 space-y-1">
          ...
          <h2 className="text-lg font-semibold text-ground-900">How we use and process your data</h2>
          <ul className="list-disc pl-6 text-ground-600 space-y-1">
          ...
          <h2 className="text-lg font-semibold text-ground-900">Who we share it with</h2>
          <ul className="list-disc pl-6 text-ground-600 space-y-1">
            ...
            <li><strong>The administering trust foundation</strong> &mdash; for applicants accepted into the {b.programmeName.en} Programme, to administer the support. <em>(Currently being established.)</em></li>
          ...
          <h2 className="text-lg font-semibold text-ground-900">Keeping and deleting your data</h2>
          <p className="text-ground-600">
          ...
          <h2 className="text-lg font-semibold text-ground-900">Your rights</h2>
          <p className="text-ground-600">
          ...
          <h2 className="text-lg font-semibold text-ground-900">Security</h2>
          <p className="text-ground-600">
