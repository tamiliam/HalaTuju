      ...
      {dialogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4"
          ...
          <div className="w-full max-w-md rounded-2xl bg-ground-0 p-6 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <label className="mt-4 block text-sm font-medium text-ground-700">{t('admin.payments.paymentDate')}</label>
            ...
            <label className="mt-4 block text-sm font-medium text-ground-700">{t('admin.payments.paymentMonth')}</label>
