      ...
      <div className="flex flex-col sm:flex-row gap-3 mt-4">
        <div className="relative flex-1 sm:max-w-xs">
          ...
          <input
            ...
            className="w-full border border-ground-200 rounded-lg pl-9 pr-3 py-2 text-sm bg-ground-0 focus:outline-none focus:ring-2 focus:ring-brand-shape focus:border-transparent"
          />
        </div>
        <select
          value={exam}
