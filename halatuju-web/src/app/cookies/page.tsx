    ...
    <main className="min-h-screen bg-ground-50">
      ...
      <div className="container mx-auto px-6 py-8 max-w-2xl">
        <div className="bg-ground-0 rounded-xl border border-ground-200 p-6 space-y-4">
          <h1 className="text-2xl font-bold text-ground-900 mb-2">{t('common.cookies')}</h1>
          <p className="text-sm text-ground-500">Last updated: June 2026</p>

          <h2 className="text-lg font-semibold text-ground-900">What Are Cookies?</h2>
          <p className="text-ground-600">
            Cookies are small text files stored on your device when you visit a website.
            They help the site remember your preferences and improve your experience.
          </p>

          <h2 className="text-lg font-semibold text-ground-900">Cookies We Use</h2>
          <p className="text-ground-600">
          ...
          <h2 className="text-lg font-semibold text-ground-900">Third-Party Cookies</h2>
          <p className="text-ground-600">
            HalaTuju does not use any advertising, tracking, or analytics cookies.
            We do not share your data with third parties.
          </p>

          <h2 className="text-lg font-semibold text-ground-900">Managing Cookies</h2>
          <p className="text-ground-600">
