      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="bg-ground-0 rounded-2xl border border-ground-200 p-8 shadow-sm">
          {step === 'confirm' ? (
            ...
            <>
              <h1 className="text-2xl font-bold text-ground-900 text-center mb-2">{t('sponsorAuth.registerTitle')}</h1>
              <p className="text-ground-600 text-center mb-6">{t('sponsorAuth.registerSubtitle')}</p>
