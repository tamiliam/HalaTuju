    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center">
      <div className="w-full max-w-md px-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
          {step === 'login' && (
            <>
              ...
              <p className="text-center text-sm text-gray-500 mt-6">
                ...
                <Link href="/sponsor/register" className="font-semibold text-blue-600 hover:underline">
          ...
          {step === 'forgot' && (
            <>
              <h1 className="text-2xl font-bold text-gray-900 text-center mb-2">{t('sponsorAuth.resetPassword')}</h1>
              <p className="text-gray-600 text-center mb-8">{t('sponsorAuth.resetSubtitle')}</p>
              {error && (
          ...
          {step === 'forgot-sent' && (
            <div className="text-center">
              <h1 className="text-2xl font-bold text-gray-900 mb-2">{t('sponsorAuth.checkEmail')}</h1>
              <p className="text-gray-600 mb-6">{t('sponsorAuth.resetSent')} <strong>{email}</strong></p>
              <button onClick={() => { setStep('login'); setError(null) }} className="text-blue-600 hover:underline text-sm">
                {t('login.backToLogin')}
              </button>
            </div>
          )}
