  ...
  return (
    <div className="flex flex-col gap-4 max-w-2xl">
      <div className="flex items-start justify-between gap-3">
        <p className="text-sm text-gray-500">{t('admin.sponsors.terms.rehearseIntro')}</p>
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">{t('admin.sponsors.terms.rehearseDoneBody')}</p>
          </div>
        ) : (
          <div className="p-5 flex flex-col gap-3">
            ...
            <p className="text-sm text-gray-500">{quiz.plain}</p>
            <p className="text-base font-semibold text-gray-900">{quiz.question}</p>
            ...
            {(answered || picked.length > 0) && (
              <div className={`rounded-lg border px-3 py-2.5 text-sm ${
                answered ? 'border-green-300 bg-green-50 text-green-800'
