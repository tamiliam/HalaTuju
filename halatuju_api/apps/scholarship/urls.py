...
from .views_admin import (
    ...
    AdminOrganisationConfigurationView,
    AdminOverviewLayoutView,
    ...
    AdminOrgRejectView,
    AdminReportingDateView,
    AdminNudgeStudentView,
    AdminRejectView,
...
urlpatterns = [
    ...
    path('admin/scholarship/organisation/configuration/', AdminOrganisationConfigurationView.as_view()),
    path('admin/scholarship/organisation/overview-layout/', AdminOverviewLayoutView.as_view()),
