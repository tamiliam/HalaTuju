...
- **Consent step layout — checklist + tech-support box moved below the button.** The outstanding-items checklist and the tech-support box now sit *below* the Give-consent button (was: checklist on top), so the consent text + action button stay the focus.
